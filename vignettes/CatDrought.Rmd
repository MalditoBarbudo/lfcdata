...
CatDrought offers precalculated data at different resolutions (200m, 1km and
1km smoothed) as rasters. This spatial data can be accesed with the
`catdrought_get_raster` function:
...
```
  ...
  - `resolution`: a character indicating the desired resolution (`200m`, `1km`
    or `smoothed`)
